...
const ProfilePage = {
  ...
  // Portal-style drop-up menu anchored to the avatar via fixed coords
  toggleAvatarMenu() {
    ...
    // Position fixed, bottom edge aligned to top of avatar, left-aligned
    ...
    menu.innerHTML =
      '<div class="notification-item" onclick="ProfilePage.closeAvatarMenu();ProfilePage.showEditModal(ProfilePage._currentProfile);" style="cursor:pointer;display:flex;align-items:center;gap:10px;padding:12px 16px">' +
